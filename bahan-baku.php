    ...
    <div class="card shadow mb-4">
      <div class="card-header">
          <div class="d-sm-flex align-items-center justify-content-between">
              ...
              <a href="tambah-bahan-baku.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                  Tambah
              </a>
          </div>
      </div>
        ...
        <div class="table-responsive">
          ...
          <tbody>
              ...
              <tr>
                  ...
                  <td scope="row"><?= $row["harga"]; ?></td>
                  <td scope="row">
                      <a type="button" href="detail-bahan-baku.php?id=<?= $row["id"]; ?>" class="btn btn-warning">Detail</a>
                      <a type="button" href="ubah-bahan-baku.php?id=<?= $row["id"]; ?>" class="btn btn-primary" >Ubah</a>
                      <a type="button" href="hapus-bahan-baku.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?');" class="btn btn-danger">Hapus</a>
                  </td>
              </tr>
              <?php endforeach; ?>
          </tbody>
