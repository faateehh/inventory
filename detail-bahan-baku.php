...
if ($_SESSION['role'] == 'admin') {
  ...
  <div class="row">
    ...
    $query = mysqli_query($conn, "SELECT * FROM bahan_baku WHERE id=$id");
    $data = mysqli_fetch_array($query);

    $nama = $data['nama'];

    $query2 = mysqli_query($conn, 
    "SELECT nama, satuan, tanggal, jumlah, sisa_stok, 'Masuk' AS `keterangan` FROM stok_masuk
    WHERE nama = '$nama'
    UNION
    SELECT nama, satuan, tanggal, jumlah, sisa_stok, 'Keluar' AS `keterangan` FROM stok_keluar
    WHERE nama = '$nama'");
        ...
        <div class="row g-2">
          <div class="mb-3 col-md-3">
              <div class="form-floating">
                ...
                <label for="floatingInputGrid" class="form-label">ID Bahan Baku</label>
              </div>
          </div>
          
          <div class="mb-3 col-md-3 form-floating">
              <div class="form-floating">
                <input type="text" class="form-control" id="floatingInputGridGrid" value="<?= $data['nama']; ?>" disabled>
          ...
          <div class="mb-3 col-md-3 form-floating">
              <div class="form-floating">
                <input type="text" class="form-control" id="floatingInputGridGrid" value="Rp <?= $data['harga']; ?>/<?= $data['satuan']; ?>" disabled>
                <label for="floatingInputGridGrid">Harga</label>
              </div>
          </div>
        </div>
      </div>
