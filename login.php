...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow p-3 mb-5 bg-body rounded">
        <div class="container">
          <a class="navbar-brand" href="#"><h6 class="float-md-start mb-0">SISTEM INFORMASI INVENTORY<br>WARUNG KEBON NUSA INDAH</h6>
        </a>
      ...
      <form>
        ...
        <div class="row col-12 comtainer">
          ...
          <div class="form-floating col-6">
            <a href="dashboard.php" class="btn btn-secondary rounded" style="margin-right: 40px;" type="button">Masuk</a>
          </div>
        </div>
      </form>
      <!-- FORM -->
