...
if ($_SESSION['role'] == 'admin') {
  ...
  <div class="row">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
        <a href="stok-masuk.php" class="nav-link active">
            <!-- <svg class="bi me-2" width="16" height="16"><use xlink:href="#speedometer2"/></svg> -->
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2 20H22V16H2V20ZM4 17H6V19H4V17ZM2 4V8H22V4H2ZM6 7H4V5H6V7ZM2 14H22V10H2V14ZM4 11H6V13H4V11Z" fill="black"/>
            </svg>
    ...
    <div class="card shadow mb-4">
      <div class="card-header">
          <div class="d-sm-flex align-items-center justify-content-between">
              <h4 class="m-0 font-weight-bold">Data Stok Masuk</h4>
              <a href="tambah-stok-masuk.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm">
                  Tambah
              </a>
          </div>
      </div>
      ...
      <div class="card-body">
        <div class="table-responsive">
          ...
          <tbody>
              <?php 
              $dataStokMasuk = mysqli_query($conn, "SELECT * FROM stok_masuk");
              $i = 1;
              ...
              <tr>
                  ...
                  <td scope="row">
                      <a type="button" href="ubah-stok-masuk.php?id=<?= $row["id"]; ?>" class="btn btn-primary" >Ubah</a>
                      <a type="button" href="hapus-stok-masuk.php?id=<?= $row["id"]; ?>" onclick="return confirm('yakin?');" class="btn btn-danger">Hapus</a>
                  </td>
              </tr>
              <?php endforeach; ?>
          </tbody>
