...
if ($_SESSION['role'] == 'admin') {
  ...
  <div class="row">
    ...
    $dataStokMasuk = mysqli_query($conn, "SELECT * FROM stok_masuk WHERE id = $id");
    $row = mysqli_fetch_array($dataStokMasuk);

    if(ISSET($_POST['ubah'])) {
      if(ubah_stok_masuk($_POST) > 0 ) {
          echo "
          <script>
    ...
    <div class="card shadow mb-4">
      <div class="card-header">
        <div class="col-3">
          <a href="stok-masuk.php" type="button" class="btn btn-outline-primary rounded-pill"><i class="fa-solid fa-arrow-left"></i> Kembali</a>
        </div>
      </div>
